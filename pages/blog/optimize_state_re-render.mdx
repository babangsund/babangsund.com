...
export const meta = {
  ...
  date: "2019-07-13",
  description: "Performance without complexity.",
  published: true,
};
...
Along with this solution though, it also led to the common occurrence, of _all_ state being stored in **global** redux state.
...
This is a contrived example, meant to display _prop drilling as highlighted by the code_, and _limited re-render performance_.
