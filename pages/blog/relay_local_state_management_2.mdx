...
export const meta = {
  ...
  date: "2019-07-24",
  description: "Is the drawer open or closed?",
  published: true,
};
...
If you haven’t read it yet, I highly recommend doing so _first_.
...
Well, maybe. But there's also the option of putting it in _localStorage_.
